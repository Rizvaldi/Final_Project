...
import FINAL_PROJECT_PWS.UAS_PWS.exceptions.NonexistentEntityException;
import FINAL_PROJECT_PWS.UAS_PWS.exceptions.PreexistingEntityException;
...
public class UasJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("FINAL_PROJECT_PWS_UAS_PWS_jar_0.0.1-SNAPSHOTPU");
